(function() {
    ...
    var LQE_CONFIG = {
        ...
        LIST_CARD_LABEL_BORDER_COLOR: '#fdd926',
        LIST_CARD_LABEL_BACKGROUND_COLOR: 'rgba(253, 217, 38, 1)', //Стандартна прозорість фону 0.8 (1 - фон не прозорий)
        LIST_CARD_LABEL_BACKGROUND_TRANSPARENT: false,
        LIST_CARD_LABEL_TEXT_COLOR: '#1A1A1A',
    ...
    var styleLQE = "<style id=\"lampa_quality_styles\">" +
        ...
        " font-family: 'Inter', 'Roboto', Arial, sans-serif; " + // Шрифт
        " font-weight: 600; " + // Жирний шрифт
        " letter-spacing: 0.3px; " + // Відстань між літерами
        ...
        " text-shadow: 0.5px 0.5px 1px rgba(0,0,0,0.0); " + // Тінь тексту
        "}" +
        "</style>";
