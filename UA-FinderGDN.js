...
var styleTracks = "<style id=\"lampa_tracks_styles\">" +
    ...
    " font-size: 0.91em !important;" + // Розмір шрифту
    " padding: 0.14em 0.35em !important;" + // Внутрішні відступи
    " border-radius: 0.7em !important;" + // Закруглення кутів
    ...
    " font-family: 'Inter', 'Roboto', Arial, sans-serif !important; " + // Шрифт
    " font-weight: 600 !important; " + // Жирність
    " letter-spacing: 0.3px !important; " + // Міжлітерна відстань
    ...
    " text-shadow: 0.5px 0.5px 1px rgba(0,0,0,0) !important; " + // Тінь для тексту
    "}" +
